...
onChangeHandler2=event=>{
  ...
  onClickHandler = () => {
    ...
    data.append('file1', this.state.selectedwatermarked)
    data.append('file2', this.state.selectedkey)
    axios.post("http://localhost:8000/upload", data)
      ...
      console.log(this.state.selectedwatermarked)
